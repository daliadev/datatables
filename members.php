...
<head>
	...
	<link rel="stylesheet" type="text/css" media="all" href="src/datatables.min.css" />
								...
								for ($i = 0; $i < $info[0]["member"]["count"]; $i++) {
									...
									if (!empty(array_filter($info2))) {
										...
										echo '<tr id="row'.$j.'" class="selectable">';
											// echo '<td style="diplay: none;">' . $i . '</td>'; //id
		...
		$(function() {
			...
			*/
			...
			$('.selectable').on('click', function(e) {
				...
				/*
				var name = rows[0].innerText;
				var forname = rows[1].innerText;
				var login = rows[2].innerText;
				var pass = rows[3].innerText;
				*/
				var member = {
					id: id,
